...
const TaskGroupMenuList: FC = (): JSX.Element => {
	...
	const selectedTaskGroup: ITaskGroup | null = useAppSelector(selectedTaskGroupSelector);
	const taskFilter: TaskFilterType = useAppSelector((state: RootState) => state.filterStates.taskFilter);
