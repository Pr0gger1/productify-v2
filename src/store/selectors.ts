...
// сайдбары
export const leftSidebarSelector = (state: RootState) =>
	state.sidebarStates.isLeftSidebarOpen;
export const rightSidebarSelector = (state: RootState) =>
	state.sidebarStates.isRightSidebarOpen;
...
// выбранные объекты
export const selectedTaskGroupSelector = (state: RootState) =>
	state.taskGroupStates.selectedTaskGroup;
export const selectedTaskSelector = (state: RootState) =>
	state.taskStates.selectedTask;

// селекторы, связанные с задачами
export const taskGroupsSelector = (state: RootState) =>
	state.taskGroupStates.allTaskGroups;
export const currentGroupTasksSelector = (state: RootState) =>
	state.taskStates.currentGroupTasks;
